			 ...
			 switch(dat)		   /*对结果执行相关操作,客户修改*/
			  {
					case CODE_KFBYZ:	 /*命令“全开”*/
						UARTSendByte('A');//PrintCom("“关闭灯光”命令识别成功\r\n");//串口输出提示信息（可删除）
						PA2=1;//让PA2端口为高电平
													 break;					
				  case CODE_DMCS:			/*命令“测试”*/
						UARTSendByte('B');//PrintCom("“打开灯光”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA1=1;//让PA1端口为高电平
													 break;

					case CODE_KD:		/*命令“复位”*/				
						UARTSendByte('C');//PrintCom("“打开窗帘”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA3=1;//让PA3端口为高电平 
													break;
					case CODE_GD:		/*命令“复位”*/				
						UARTSendByte('D');//PrintCom("“关闭窗帘”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA3=0;//让PA3端口为低电平
													break;
					case CODE_BJ:		/*命令“复位”*/				
						UARTSendByte('E');//PrintCom("“打开空调”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA4=1;//让PA4端口为高电平
													break;
					case CODE_SH:		/*命令“关闭空调”*/				
						//PrintCom("“上海”命令识别成功\r\n"); //串口输出提示信息（可删除）
						UARTSendByte('F');
						PA5=1;//让PA5端口为高电平
													break;
